...
public class UserData {
	...
	public String toString() {
		...
		builder.append("UserData [account_id=");
		builder.append(account_id);
		builder.append(", cloud_id=");
		builder.append(cloud_id);
		builder.append(", cluster_id=");
		builder.append(cluster_id);
		builder.append(", serverrole_id=");
		builder.append(serverrole_id);
		builder.append(", cluster_serverrole_id=");
		builder.append(cluster_serverrole_id);
		...
		builder.append(secret_key);
		builder.append(", rabbitmq_host=");
		builder.append(rabbitmq_host);
		builder.append(", rabbitmq_port=");
		builder.append(rabbitmq_port);
		builder.append(", rabbitmq_ssl=");
		builder.append(rabbitmq_ssl);
		builder.append(", rabbitmq_down_exchange=");
		builder.append(rabbitmq_down_exchange);
		builder.append(", rabbitmq_down_queue=");
		builder.append(rabbitmq_down_queue);
		builder.append(", rabbitmq_up_exchange=");
		builder.append(rabbitmq_up_exchange);
		builder.append(", rabbitmq_vhost=");
		builder.append(rabbitmq_vhost);
		builder.append(", restapi_endpoint=");
		builder.append(restapi_endpoint);
		builder.append(", hasDisk=");
		builder.append(hasDisk);
		builder.append(", diskType=");
		builder.append(diskType);
		builder.append(", diskRaidType=");
		builder.append(diskRaidType);
		builder.append(", diskFileSystem=");
		builder.append(diskFileSystem);
		builder.append(", diskMountPoint=");
		builder.append(diskMountPoint);
		builder.append(", hostname_type=");
		builder.append(hostname_type);
		builder.append(", hostname=");
		builder.append(hostname);
		builder.append(", cluster_name=");
		builder.append(cluster_name);
		builder.append(", cluster_role_name=");
		builder.append(cluster_role_name);
		builder.append(", server_name=");
		builder.append(server_name);
		builder.append(", cluster_type=");
		builder.append(cluster_type);
		builder.append(", enterprise_internal_ip=");
		builder.append(enterprise_internal_ip);
		builder.append(", enterprise_external_ip=");
		builder.append(enterprise_external_ip);
		builder.append(", master_repo=");
		builder.append(master_repo);
		builder.append(", backup_repo=");
		builder.append(backup_repo);
		builder.append("]");
